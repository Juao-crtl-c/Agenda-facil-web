                ...
                <div className="mt-2 flex flex-col gap-2">
                  ...
                  {doDia.map((a) => (
                    ...
                    >
                      ...
                      {a.status === "CANCELADO" && <p className="text-rose-600 dark:text-rose-400">cancelado</p>}
                    </div>
                  ))}
                </div>
              </div>
        ...
        <div>
          ...
          <div className="card-glass mt-2 divide-y divide-border">
            ...
            {bloqueios?.map((b) => (
              <div key={b.id} className="p-3 text-xs">
                ...
                <button onClick={() => removerBloqueio(b.id)} className="mt-1 text-rose-600 hover:underline dark:text-rose-400">
                  remover
                </button>
              </div>
            ))}
          ...
          <form onSubmit={criarBloqueio} className="card-glass mt-3 flex flex-col gap-2 p-3">
            ...
            <input
              ...
              className="field text-xs"
            />
            {erroBloqueio && <p className="text-xs text-rose-600 dark:text-rose-400">{erroBloqueio}</p>}
